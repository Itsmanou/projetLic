  ...
  return (
    <div className="bg-white shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
      <div className="relative">
        ...
        {/* Badge */}
        {produit.stock === 0 && (
          <div className="absolute top-3 left-3 bg-red-500 text-white text-xs font-semibold rounded-full px-3 py-1">
            Rupture
          </div>
        )}
      </div>
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white font-semibold px-4 py-2 transition-all duration-200 hover:bg-blue-700 flex items-center justify-center gap-2"
        >
